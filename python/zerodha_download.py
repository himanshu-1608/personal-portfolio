...
# Options: "last 7 days", "last 30 days", "prev. FY", "current FY". Widened from
# "last 7 days" to "last 30 days": MTF settlement rows (pledge/unpledge,
# obligation, interest) post ~T+1..T+2, so a 30-day window still recovers them
# even if a nightly run is missed. The merge dedups, so re-fetching old rows is
# harmless.
RANGE_SHORTCUT = "last 30 days"
